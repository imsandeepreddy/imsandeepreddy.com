    ...
    <>
      <div className="mb-10 items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        ...
        <div className=" prose pt-8 pb-8 dark:prose-dark xl:col-span-2">
          ...
          <p>
            I am a product manager by day and self-taught developer and designer
            by night. Embracing being a generalist and aspiring to become a
            polymath.
          </p>
          <p>
            Currently experimenting with with life design and digital products.
            Feel free to learn more <Link href="/about">about me</Link>, ping me
            on <a href="https://twitter.com/sokirill">Twitter</a> or sign-up for
            my essays.
          </p>
        </div>
      </div>
