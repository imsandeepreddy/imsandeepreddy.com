![Kirill So Welcome](/public/static/images/twitter-card.png)

## Intro

This a personal blog and portfolio website made with [Next.js](https://nextjs.org/) & [Tailwind CSS](https://tailwindcss.com/), adapted from [Timothy Lin's](https://www.timlrx.com) Next.js Starter Template which took inspriation from [Lee Robinson's](https://www.leerob.io) now infamous Next.js blog.
